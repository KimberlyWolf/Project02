...
public class Settings {
     ...
     * @param minimumRequiredPeoplePerClass Minimum number of people per each class
     ...
     * @param numberOfClasses Number of points we want each nation to have
     */
    ...
    /**
     * @return The number of people required for each unique class
     */
    ...
    /**
     * Sets the minimum number of classes per game to the parameter requiredClassCount.
     * @param requiredClassCount Number of points we want each nation to have
     */
